...
export function FeedCard({ post }: FeedCardProps) {
  ...
  return (
    <article
      className="bg-white rounded-3xl border-[1.5px] border-black/90 overflow-hidden transition-all duration-200 ease-out
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-3.5 pt-3 pb-2.5 border-b-[1.5px] border-black/90">
        <Link
      ...
      <div className="border-t-[1.5px] border-black/90" />
